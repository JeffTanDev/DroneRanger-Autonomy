...
- **drone_autonomy**：`orbit_point`、`forward_mission`、`simple_takeoff`、`square_flight`、`circle_flight`、`figure_eight`、`waypoint_mission`、`house_inspection`、`pursuit_flight`、`rrt_pursuit_single`

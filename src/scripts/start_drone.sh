...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    --help|-h)
      ...
      echo "  --mission        offboard_takeoff, offboard_square_mission, orbit_point, forward_mission, ..."
...
case "$MISSION" in
  ...
  unity_house_avoidance)
    ...
    ;;
  orbit_point|forward_mission|simple_takeoff|square_flight|circle_flight|figure_eight|waypoint_mission|house_inspection|pursuit_flight|rrt_pursuit_single)
